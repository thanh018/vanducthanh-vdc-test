...
module.exports = {
  ...
  '@table-header-bg': '#f0f2f4',
  '@table-header-color': '#595c97',
  '@table-footer-bg': '#f0f2f4',
  '@table-footer-color': '#595c97',
  '@table-row-hover-bg': '#e4e9f0',
  '@table-selected-row-bg': '#f0f2f4',
  '@table-expanded-row-bg': '#f0f2f4',
